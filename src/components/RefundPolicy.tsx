...
import { RotateCcw, FileText, Info, ClipboardList, Ban, StretchHorizontal } from "lucide-react";
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <span className="font-bold text-green-700">Full Refund Available</span><br />
          A full refund is available if the cancellation request is made within 7 days of payment and the SOP drafting work has not yet started.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <span className="font-bold text-red-700">No Refund</span><br />
          Once the SOP writing or drafting process has started, no refund will be issued, as the service involves personalized time, effort, and intellectual work.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <>
          <span className="font-bold text-blue-700">Available</span><br />
          Instead of a refund, clients may request:<br />
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>Switching to another SOP (different university/course)</li>
            <li>Conversion to another writing service (LOR, Motivation Letter, etc.)</li>
            <li>Rescheduling or holding the service for future use</li>
          </ul>
          <span className="text-sm text-muted-foreground mt-2 block">Note: Additional charges may apply based on service scope.</span>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <span className="font-bold text-indigo-700">Step 1: Request</span><br />
          All refund or modification requests must be submitted in writing to <a href="mailto:connect@globalmindsindia.com" className="text-primary hover:underline inline-block">&#128231; connect@globalmindsindia.com</a>, including payment and service details.<br /><br />
          <span className="font-bold text-indigo-700">Step 2: Review & Processing</span><br />
          Approved refunds (if applicable) will be processed within 14 business days to the original payment method.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Purpose of service (SOP for which country/course/university)</li>
      ...
      content: (
        <>
          <ul className="list-disc pl-6 space-y-1 text-red-600">
            <li>Work on SOP has already started (drafting or consulting initiated)</li>
            <li>Client fails to provide required information or stops responding</li>
            <li>Final draft or multiple revisions have been delivered</li>
            <li>Change of mind or university decision outcomes (rejection/withdrawal)</li>
          </ul>
        </>
      ),
    },
      ...
      content: (
        <>
          <div>
            ...
            <a href="mailto:connect@globalmindsindia.com" className="text-primary hover:underline">connect@globalmindsindia.com</a>
          </div>
          <div>
            <span className="mr-2">&#128222;</span>
            <a href="tel:+917353446655" className="text-primary hover:underline">+91-7353446655</a>
          </div>
        </>
      ),
    },
  ...
  return (
    <Layout>
      <section className="py-16 bg-gradient-to-b from-blue-50 via-white to-purple-50 min-h-screen px-2 sm:px-6 lg:px-16">
        {/* Header design matching TermsAndConditions style */}
        <div className="max-w-2xl mx-auto text-center flex flex-col items-center mb-10">
          <div className="flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-indigo-400 via-purple-500 to-purple-400 shadow-lg mb-4">
            <RotateCcw size={38} className="text-white" />
          </div>
          ...
          <p className="text-xl text-muted-foreground font-normal">
            Understanding our refund and cancellation policies for SOP Writing Services
          </p>
        </div>
