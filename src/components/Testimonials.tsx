...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="py-20 bg-background from-[hsl(var(--hero-gradient-start))] to-[hsl(var(--hero-gradient-end))] "
    >
      <div className="container-app">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto">
            Real stories from students who achieved their dreams with expert
            guidance. Join hundreds of successful applicants worldwide.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden mb-16">
          ...
          >
            {fullTestimonials.map((testimonial, index) => (
              ...
              >
                <Card className="w-full h-full bg-card border border-muted shadow-md hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 h-full">
                    {/* Header */}
                    <div className="flex items-center space-x-3 mb-4">
                      <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary font-heading font-bold flex-shrink-0">
                        {testimonial.image}
                      </div>
                    ...
                    {/* Content */}
                    <p className="font-body text-sm text-muted-foreground italic leading-relaxed line-clamp-4">
                      "{testimonial.content}"
                    </p>
                  </CardContent>
                </Card>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-card border border-muted hover:bg-muted/50 shadow-md rounded-full p-2 transition-all duration-300 z-10"
          >
            <ChevronLeft className="h-5 w-5 text-foreground" />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-card border border-muted hover:bg-muted/50 shadow-md rounded-full p-2 transition-all duration-300 z-10"
          >
        ...
        <div className="text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="bg-card border border-muted shadow-md p-6 rounded-xl">
